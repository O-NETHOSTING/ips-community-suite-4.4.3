...
class _Url
{
	 ...
	 */
	public function request( $timeout=null, $httpVersion=null, $followRedirects=5, $skipLocalhostRedirects=FALSE )
	{
		...
		if ( \function_exists( 'curl_init' ) and \function_exists( 'curl_exec' ) and \IPS\BYPASS_CURL === false )
		{
			...
			{
				$requestObj	= new \IPS\Http\Request\Curl( $this, $timeout, $httpVersion, $followRedirects, $skipLocalhostRedirects );
			}
		}
		...
		if( !isset( $requestObj ) )
		{
			$requestObj	= new \IPS\Http\Request\Sockets( $this, $timeout, $httpVersion, $followRedirects, $skipLocalhostRedirects );
		}
