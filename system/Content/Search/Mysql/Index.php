...
class _Index extends \IPS\Content\Search\Index
{
	...
	public function prune( \IPS\DateTime $cutoff = NULL )
	{
		if ( $cutoff )
		{
			...
			\IPS\Db::i()->delete( array( 'core_search_index_item_map', 'core_search_index' ), array( "core_search_index_item_map.index_item_id=core_search_index.index_item_id AND index_date_updated < ? ", $cutoff->getTimestamp() ), NULL, NULL, NULL, 'core_search_index_item_map' );
			\IPS\Db::i()->delete( array( 'core_search_index_tags', 'core_search_index' ), array( "core_search_index_tags.index_id=core_search_index.index_id AND index_date_updated < ? ", $cutoff->getTimestamp() ), NULL, NULL, NULL, 'core_search_index_tags' );
