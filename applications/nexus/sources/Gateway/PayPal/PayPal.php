...
class _PayPal extends \IPS\nexus\Gateway
{
	...
	public function settings( &$form )
	{
		...
		$form->add( new \IPS\Helpers\Form\Radio( 'paypal_billing_agreements', ( $this->id AND isset( $settings['billing_agreements'] ) ) ? (string) $settings['billing_agreements'] : '', FALSE, array( 'options' => array(
