...
{	
	...
	{
		$table = \IPS\nexus\Payout::table( array( 'po_status=?', 'pend' ), \IPS\Http\Url::internal('app=nexus&module=payments&controller=payouts') );
		$table->limit = 10;
		$table->filters = array();
	...
	{
		return \IPS\Http\Url::internal('app=nexus&module=payments&controller=payouts');
	}
