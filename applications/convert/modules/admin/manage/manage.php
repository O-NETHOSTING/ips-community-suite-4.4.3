...
{	
	...
	protected function manage()
	{
		...
		$table->include = array( 'app_key', 'sw', 'finished' );
		
		$table->parsers = array(
			'sw'				=> function( $val, $row )
			{
				/* The main row will always be the core application */
				$applications = array( \IPS\Application::load( $val )->_title );
	...
	public function software()
	{
		...
		if ( $values = $form->values() )
		{
			...
			$exploded		= explode( '\\', $values['classname'] );
