...
{	
	...
	{
		return $this->_details['security'] ? \IPS\Member::loggedIn()->language()->addToStack( 'dashboard_version_info_security', FALSE, array( 'sprintf' => array( $this->_details['version'] ) ) ) : \IPS\Member::loggedIn()->language()->addToStack( 'dashboard_version_info', FALSE, array( 'sprintf' => array( $this->_details['version'] ) ) );
	}
	...
	{
		return $this->_details['security'] ? static::STYLE_ERROR : static::STYLE_INFORMATION;
	}
