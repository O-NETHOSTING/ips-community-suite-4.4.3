...
class _Giphy
{
	...
	{
		$this->enabled = ( \IPS\Settings::i()->giphy_enabled and \IPS\Settings::i()->giphy_apikey );
	}
	...
	public function edit()
	{
		...
		$form->add( new \IPS\Helpers\Form\Text( 'giphy_apikey', \IPS\Settings::i()->giphy_apikey ? \IPS\Settings::i()->giphy_apikey : '', FALSE ) );
		...
		if ( $values = $form->values() )
		{
			try
			{
				...
				if ( ! \IPS\Settings::i()->giphy_enabled AND ! empty( $values['giphy_apikey'] ) )
				{
