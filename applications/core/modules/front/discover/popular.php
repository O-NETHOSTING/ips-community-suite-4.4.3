...
class _popular extends \IPS\Dispatcher\Controller
{
	...
	protected function leaderboard()
	{
		...
		{
			$innerQuery = \IPS\Db::i()->select( 'core_reputation_index.member_received as member, SUM(rep_rating) as rep', 'core_reputation_index', $innerQueryWhere, NULL, NULL, 'member' );
		}
